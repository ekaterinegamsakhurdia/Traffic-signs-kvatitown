...
class FinalProjectAgent:
    ...
    def compute_commands(self, frame_rgb, detections=None) -> Tuple[float, float]:
        ...
        # Only log when something interesting is happening — suppress the
        # per-frame spam when the robot is just following the lane with nothing
        # notable in view.
        plain_lane_follow = (
            decision.state.value == "LANE_FOLLOW"
